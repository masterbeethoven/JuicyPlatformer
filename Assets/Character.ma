...
//Name: Character.ma
//Last modified: Thu, Oct 24, 2013 12:18:15 PM
//Codeset: UTF-8
requires maya "2014";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -17.653829898859513 21.315187976253469 32.581568029039659 ;
	setAttr ".r" -type "double3" -37.538352729593583 -21.400000000005782 1.7080365254564157e-15 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 43.92137720387845;
...
createNode transform -n "LegLeft" -p "Torso";
	setAttr ".rp" -type "double3" -0.74999157078046952 0.87079238607959264 0.046778437314542454 ;
	setAttr ".sp" -type "double3" -0.74999157078046963 0.87079238607959286 0.14442512549788328 ;
	setAttr ".spt" -type "double3" 1.1102230246251564e-16 -2.2204460492503128e-16 -0.097646688183340727 ;
...
createNode animCurveTL -n "Torso_translateX";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  1 -0.74468261295481675;
createNode animCurveTL -n "Torso_translateY";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  1 6.0243267151028537;
createNode animCurveTL -n "Torso_translateZ";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  1 0.42138097426467475;
...
createNode animCurveTU -n "Torso_scaleZ";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  1 2.8162700049404701;
createNode animCurveTU -n "LegLeft_visibility";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  1 1 6 1 18 1;
	setAttr -s 3 ".kot[0:2]"  5 5 5;
createNode animCurveTL -n "LegLeft_translateX";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  1 -2.7755575615628914e-16 6 -2.7755575615628914e-16
		 18 -2.7755575615628914e-16;
createNode animCurveTL -n "LegLeft_translateY";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  1 -3.2983395704004903 6 -3.2983395704004903
		 18 -3.2983395704004903;
createNode animCurveTL -n "LegLeft_translateZ";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  1 0.22020687469972355 6 0.22020687469972355
		 18 0.22020687469972355;
createNode animCurveTA -n "LegLeft_rotateX";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  1 0 6 -0.72223600115149511 18 3.9570216326225638;
createNode animCurveTA -n "LegLeft_rotateY";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  1 0 6 -4.3957292220999067 18 -2.047360069582413;
createNode animCurveTA -n "LegLeft_rotateZ";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  1 0 6 26.918087140446282 18 -45.10712168932087;
...
createNode animCurveTU -n "LegLeft_scaleZ";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  1 0.3238940395812786 6 0.3238940395812786
		 18 0.3238940395812786;
...
createNode animCurveTL -n "LegRight_translateY";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  1 -3.2983395704004908 6 -3.2983395704004908
		 18 -3.2983395704004908;
createNode animCurveTL -n "LegRight_translateZ";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  1 -0.23142813900004572 6 -0.23142813900004572
		 18 -0.23142813900004572;
...
createNode animCurveTA -n "LegRight_rotateZ";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  1 0 6 -30.000000000000011 18 30.000000000000011;
...
createNode animCurveTL -n "ArmLeft_translateY";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  1 -0.59478550523598539;
createNode animCurveTL -n "ArmLeft_translateZ";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  1 0.62720834268400871;
...
createNode animCurveTU -n "ArmLeft_scaleZ";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  1 0.3238940395812786;
...
createNode animCurveTL -n "ArmRight_translateZ";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  1 -0.60554145133406645;
...
createNode animCurveTL -n "Head_translateY";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  1 3.0620330511103901;
...
createNode animCurveTU -n "Head_scaleY";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  1 0.67655013300543365;
createNode animCurveTU -n "Head_scaleZ";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  1 0.81305487429474033;
select -ne :time1;
	setAttr ".o" 14;
	setAttr ".unw" 14;
